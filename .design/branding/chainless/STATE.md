...
| 3 | Identity | complete | 2026-03-22 | 2026-03-22 |
...
## Decisions
- Strategy and identity completed outside GSP structure (2026-03-22)
- Archetype: Magician 70% / Ruler 30%
- Voice: Bold, Defiant, Warm — 60/40 premium/rebel
- Color preserved: #FFC73D yellow-500, #1C1B19 dark-500
- Typography: Sohne (identity spec) → Satoshi (implementation, free alternative)
- Fraunces as accent serif, IBM Plex Mono preserved
- Light-mode default per identity spec, but landing currently all-dark
...
## Notes
- Brand artifacts live in /strategy and /identity (outside .design/) — created before GSP adoption
