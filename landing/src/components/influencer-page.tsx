                ...
                <div className="mt-10 flex flex-col gap-3 md:mt-14 md:inline-flex" id="codigo">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row">
                    <a
                      ...
                      className="flex flex-1 items-center justify-center gap-2.5 rounded-xl px-4 py-3 transition-all duration-500 ease-premium active:scale-[0.97] sm:gap-3 sm:px-5"
                      style={{
                        background: "linear-gradient(135deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.02) 50%, rgba(255,255,255,0.05) 100%)",
                        boxShadow: "inset 0 1px 0 rgba(255,255,255,0.1), 0 2px 12px -4px rgba(0,0,0,0.15)",
                        border: "1px solid rgba(255,255,255,0.08)",
                    ...
                    >
                      <svg viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6 shrink-0 text-yellow-500/80">
                        <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                      </svg>
                      <div className="flex flex-col">
                        <span className="whitespace-nowrap text-[10px] font-medium leading-none text-white/50">Disponível na</span>
                        <span className="whitespace-nowrap text-sm font-semibold leading-tight text-text-primary/80">App Store</span>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        <span className="whitespace-nowrap text-[10px] font-medium leading-none text-white/50">Disponível no</span>
                        <span className="whitespace-nowrap text-sm font-semibold leading-tight text-text-primary/80">Google Play</span>
                      </div>
                    </a>
                  </div>
                </div>
