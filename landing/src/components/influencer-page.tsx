                  ...
                  <div className="flex flex-col gap-3 sm:flex-row">
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        <span className="whitespace-nowrap text-xs font-medium leading-none text-white/50">Disponível na</span>
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        <span className="whitespace-nowrap text-xs font-medium leading-none text-white/50">Disponível no</span>
