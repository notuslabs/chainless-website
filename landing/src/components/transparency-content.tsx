      ...
      <div className="mx-auto max-w-[780px]">
        ...
        <FadeUp>
          <div className="legal-prose mt-12 space-y-10 text-[0.9375rem] leading-[1.85] text-text-secondary">
            ...
            <section>
              <h2>3. Modelo operacional da Chainless</h2>
              <p>
                A Chainless atua exclusivamente como <strong>provedora de infraestrutura tecnológica</strong>, disponibilizando software que permite ao usuário final interagir diretamente com redes blockchain públicas. O modelo operacional compreende dois eixos:
              </p>

              <h3>3.1. Autocustódia integral</h3>
              <p>
                A Chainless disponibiliza ao usuário uma carteira digital de autocustódia (<em>self-custody wallet</em>). A geração, o armazenamento e o controle das chaves privadas ocorrem exclusivamente no dispositivo do usuário. A Chainless:
              </p>
              <ul>
              ...
              <p>
                A Chainless atua como camada de software (<em>middleware</em>) que conecta o usuário a terceiros, sem participação operacional na execução das transações:
              </p>
              <ul>
                <li>
                  <strong>Operações cripto–cripto:</strong> o usuário interage diretamente com protocolos descentralizados (<em>DeFi</em>) por meio da carteira. A execução ocorre <em>on-chain</em>, sem intermediação, custódia ou contraparte da Chainless.
                </li>
                <li>
              ...
              <p>
                A receita da Chainless é composta exclusivamente por taxas (<em>fees</em>) cobradas pela utilização da interface tecnológica, constituindo remuneração pelo licenciamento de software e prestação de serviço de tecnologia.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Em decorrência do modelo operacional descrito, a Chainless não realiza reporte de saldos, posições ou operações <em>on-chain</em> dos usuários à Secretaria Especial da Receita Federal do Brasil (&ldquo;RFB&rdquo;).
              </p>
              <p>
              ...
              <p>
                Em ambiente de finanças descentralizadas (<em>DeFi</em>), a legislação vigente atribui a responsabilidade de declaração ao próprio contribuinte titular dos ativos, conforme orientação da RFB. A Chainless não detém os dados necessários para realizar tal reporte, uma vez que não mantém registro de posições ou transações <em>on-chain</em> dos usuários.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Para esclarecimentos adicionais, o usuário pode contatar a Chainless pelo canal <a href="mailto:support@chainless.finance">support@chainless.finance</a>.
              </p>
            </section>
