        ...
        <FadeUp>
          <dl className="grid grid-cols-3 py-7 md:py-9">
            {proof.map((item, i) => (
              ...
              >
                <dd className="font-mono text-xl sm:text-2xl md:text-3xl font-medium text-[#FAFAF8] tabular-nums tracking-tight">
                  <AnimatedCounter
                ...
                <dt className="mt-1.5 text-[10px] sm:text-[11px] text-warm-400/50 tracking-wide">
                  {item.label}
                </dt>
              </div>
            ))}
